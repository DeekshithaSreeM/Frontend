      ...
      <div style={{ position: "sticky", top: "0px", zIndex: "5" }}>
        ...
        <div className="buttons-container" style={{ paddingRight: "0" }}>
          ...
          <div
            ...
            onClick={() => setdisplayType("attentions")}
          >
          ...
          <div
            style={{ marginLeft: "-15%", paddingRight: "20px" }}
            onClick={() => setdisplayType("errors")}
          >
            <img src={error} alt="" />
            <span>{count.errors} Errors</span>
          </div>
          <div
            style={{ marginLeft: "-15%", paddingRight: "20px" }}
            onClick={() => setdisplayType("warnings")}
          >
            <img src={warning} alt="" />
          ...
          <div
            style={{ marginLeft: "-15%", paddingRight: "20px" }}
            onClick={() => setdisplayType("messages")}
          >
            <img src={message} alt="" />
            <span>{count.messages} Messages</span>
          </div>
          <div
            style={{ marginLeft: "-15%", paddingRight: "30px" }}
            onClick={() => setdisplayType("tradings")}
          >
            <img src={trading} alt="" />
